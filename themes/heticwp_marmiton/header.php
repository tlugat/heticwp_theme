...
<body>
    <?php if (home_url($_SERVER['REQUEST_URI']) !== home_url('/login')) : ?>
        <?php if (home_url($_SERVER['REQUEST_URI']) !== home_url('/register')) : ?>
            <header>
                <nav class="navbar navbar-expand-lg navbar-light mb-4">
                    <div class="container-fluid">
                        <a class="px-5 nav-title" href="/"><?php bloginfo('name') ?></a>
